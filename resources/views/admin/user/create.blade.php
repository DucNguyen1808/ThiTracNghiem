        ...
        <form method="POST" action="{{ route('user.store') }}">
            <div class="mx-auto flex items-center flex-col w-3/4 bg-white rounded-lg p-4 ">
                ...
                <div class="mt-4 w-full ">
                    ...
                    <input type="text" class="w-full border-2 p-1 rounded-[6px] outline-none" name="ten">
                </div>
                <div class="mt-4 w-full">
                    <div>
                        <label class="text-Mplanet text-sm font-medium" for="tenMon">Email</label>
                    </div>
                    <input type="text" class="w-full border-2 p-1 rounded-[6px] outline-none" name="email">
                </div>
                <div class="mt-4 w-full flex items-center">
                    <label class="text-Mplanet text-sm font-medium mr-4" for="tenMon">Giới tính</label>
                    <input type="radio" value="Nam" class="" name="gioitinh">Nam
                    <input type="radio" value="Nữ" class="ml-6" name="gioitinh">Nữ
                </div>
                <div class="mt-4 w-full">
                    <div>
                        <label class="text-Mplanet text-sm font-medium" for="tenMon">Ngày sinh</label>
                    </div>
                    <input type="date" class="w-full border-2 p-1 rounded-[6px] outline-none" name="ngaysinh">
                </div>
                <div class="mt-4 w-full">
                    <label for="countries" class="block mb-2 text-sm font-medium text-Mplanet dark:text-white">Nhóm quền</label>
                ...
                <div class="mt-4 w-full">
                    <div>
                        <label class="text-Mplanet text-sm font-medium" for="tenMon">Mật khẩu</label>
                    </div>
                    <input type="text" class="w-full border-2 p-1 rounded-[6px] outline-none" name="matkhau">
                </div>
